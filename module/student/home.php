...
<body>
    <nav class="navbar navbar-default custom-header">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand navbar-link" href="#">GEOMSCHOOLS</a>
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav links">
                    ...
                    <li><a href="#">MY COURSE AND RESULT</a></li>
                    <li><a href="#" class="custom-navbar"> MY EXAM SCHEDULE</a></li>
                    <li><a href="#" class="custom-navbar">MY ATTENDANCE</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="codeintech">
        ...
        <p class="hero-subtitle">FREE CODES JUST FEW CLICKS AND YOU ARE THERE</p>
        <p><a class="btn btn-primary btn-lg hero-button" role="button" href="#">clickme</a></p>
    </div>
    <footer>
        <div class="row">
            <div class="col-md-4 col-sm-6 footer-navigation">
                <h3><a href="#">GEOMMSCHOOLS</a></h3>
